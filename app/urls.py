...
from .views import ExpanseCreate,ExpanseDelete,ExpanseUpdate,ExpanseList,ExpanseDetails,RecipetDelete,RecipetList,RecipetCreate,CategoryCreate,CategoryDelete,CategoryUpdate,CategoryList,CategoryView
...
urlpatterns=[
    ...
    path('api/category/view/', CategoryView.as_view()),

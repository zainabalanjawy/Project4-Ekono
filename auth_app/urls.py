...
from .views import UserDestroyView, UserListView, UserUpdateView, UserRetrieveView, UserRetrieveOneView
...
urlpatterns = [
    ...
    path('profile/', UserRetrieveView.as_view(), name='rest_view_profile'),
    path('<pk>/profile/', UserRetrieveOneView.as_view(), name='rest_view_profile'),
